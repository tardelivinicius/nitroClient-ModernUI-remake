    ...
    private onNitroEvent(event: NitroEvent): void
    {
        ...
        switch(event.type)
        {
            ...
            case ConfigurationEvent.FAILED:
                ...
                {
                    this.isError    = true;
                    this.message    = 'Falha no arquivo de configurações';
                });
                return;
            ...
            case NitroCommunicationDemoEvent.CONNECTION_HANDSHAKE_FAILED:
                ...
                {
                    this.isError    = true;
                    this.message    = 'Falha na comunicação com o emulador (Verifique ticket e conexões)';
                });
                return;
            case NitroCommunicationDemoEvent.CONNECTION_AUTHENTICATED:
                this._ngZone.run(() =>
                {
                    this.message = 'Entrando no hotel';
                });
            ...
            case NitroCommunicationDemoEvent.CONNECTION_CLOSED:
                ...
                {
                    this.isError    = true;
                    this.message    = 'Conexão encerrada';
                });
            ...
            case NitroLocalizationEvent.LOADED:
                Nitro.instance.core.asset.downloadAssets(this.getPreloadAssetUrls(), (status: boolean) =>
                {
                    ...
                    else
                    {
                        ...
                        {
                            this.isError    = true;
                            this.message    = 'Falha ao carregar Assets';
                        });
                    }
                });
                return;
